...
#define R__DICTIONARY_FILENAME dIhomedIsrcuser2dIbmnrootdIbuilddIreconstructiondIscwalldIG__BmnRecoScWallDict
...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::BmnScWallAnalyzer*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("BmnScWallAnalyzer", ::BmnScWallAnalyzer::Class_Version(), "BmnScWallAnalyzer.h", 39,
...
namespace ROOT {
   static TClass *maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR_Dictionary();
   static void maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR_TClassManip(TClass*);
   static void *new_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p = nullptr);
   static void *newArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(Long_t size, void *p);
   static void delete_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p);
   static void deleteArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p);
   static void destruct_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p);
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const map<unsigned int,vector<unsigned int> >*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("map<unsigned int,vector<unsigned int> >", -2, "map", 100,
                  typeid(map<unsigned int,vector<unsigned int> >), ::ROOT::Internal::DefineBehavior(ptr, ptr),
                  &maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR_Dictionary, isa_proxy, 0,
                  sizeof(map<unsigned int,vector<unsigned int> >) );
      instance.SetNew(&new_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR);
      instance.SetNewArray(&newArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR);
      instance.SetDelete(&delete_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR);
      instance.SetDeleteArray(&deleteArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR);
      instance.SetDestructor(&destruct_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR);
      ...
      ::ROOT::AddClassAlternate("map<unsigned int,vector<unsigned int> >","std::map<unsigned int, std::vector<unsigned int, std::allocator<unsigned int> >, std::less<unsigned int>, std::allocator<std::pair<unsigned int const, std::vector<unsigned int, std::allocator<unsigned int> > > > >");
      return &instance;
   }
   // Static variable to force the class initialization
   static ::ROOT::TGenericClassInfo *_R__UNIQUE_DICT_(Init) = GenerateInitInstanceLocal((const map<unsigned int,vector<unsigned int> >*)nullptr); R__UseDummy(_R__UNIQUE_DICT_(Init));

   // Dictionary for non-ClassDef classes
   static TClass *maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR_Dictionary() {
      TClass* theClass =::ROOT::GenerateInitInstanceLocal((const map<unsigned int,vector<unsigned int> >*)nullptr)->GetClass();
      maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR_TClassManip(theClass);
   return theClass;
   }
...
namespace ROOT {
   // Wrappers around operator new
   static void *new_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p) {
      return  p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) map<unsigned int,vector<unsigned int> > : new map<unsigned int,vector<unsigned int> >;
   }
   static void *newArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(Long_t nElements, void *p) {
      return p ? ::new((::ROOT::Internal::TOperatorNewHelper*)p) map<unsigned int,vector<unsigned int> >[nElements] : new map<unsigned int,vector<unsigned int> >[nElements];
   }
   // Wrapper around operator delete
   static void delete_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p) {
      delete ((map<unsigned int,vector<unsigned int> >*)p);
   }
   static void deleteArray_maplEunsignedsPintcOvectorlEunsignedsPintgRsPgR(void *p) {
      delete [] ((map<unsigned int,vector<unsigned int> >*)p);
   }
...
"/home/srcuser2/bmnroot/base/header",
"/home/srcuser2/bmnroot/reconstruction/scwall",
"/home/srcuser2/bmnroot/detectors/scwall",
"/home/srcuser2/bmnroot/detectors/dch",
"/home/srcuser2/bmnroot/decoder",
"/opt/fairsoft/install/include/root",
"/opt/fairsoft/install/include/vmc",
"/opt/fairsoft/install/include/root",
"/home/srcuser2/bmnroot/build/reconstruction/scwall/",
nullptr
    };
